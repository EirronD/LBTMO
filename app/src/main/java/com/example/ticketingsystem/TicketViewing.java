...
public class TicketViewing extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String registrationNumber = intent.getStringExtra("registrationNumber");
        ...
        Toast.makeText(this, "Street ID: " + streetId, Toast.LENGTH_SHORT).show();
    ...
    private void saveTicketAndViolations(String driverId) {
        ...
        ticketData.put("DATE_VALIDATED", now());
    ...
    private void passDataBackToIssuesTickets() {
        ...
        intent.putExtra("registrationNumber", regNumberTv.getText().toString());
        intent.putExtra("vehicleNumber", vehicleNumberTv.getText().toString());
